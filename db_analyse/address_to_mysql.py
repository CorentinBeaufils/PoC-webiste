...
output_file_path = 'C:/Users/trice/Documents/all_addresses.xlsx'

# Lire le fichier Excel
df = pd.read_excel(file_path)

# Colonnes à utiliser
address_type_column = 'Customer_Address::Address_Type'
complete_address_column = 'Customer_Address::Complete_Address'
main_address_column = 'Customer_Main_Address::Complete_Address'
